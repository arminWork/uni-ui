<template>
	<view>
		...
		<view class="example-body"><uni-nav-bar left-icon="back" @click-left="back" title="标题"></uni-nav-bar></view>

		<view class="example-title">左右显示文字</view>
		<view class="example-body"><uni-nav-bar left-icon="back" right-text="菜单" left-text="返回" @click-left="back" title="标题"></uni-nav-bar></view>
